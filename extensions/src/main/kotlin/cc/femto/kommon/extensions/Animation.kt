...
fun View.fadeInVertical(startDelay: Long = 0, build: (ViewPropertyAnimator.() -> Unit)? = null)
        = translate(initY = AnimationConstants.TRANSLATION_SMALL, translationY = 0, alpha = 1f, startDelay = startDelay) {
...
fun View.fadeOutVertical(startDelay: Long = 0, build: (ViewPropertyAnimator.() -> Unit)? = null)
        = translate(translationY = -AnimationConstants.TRANSLATION_SMALL, alpha = 0f, startDelay = startDelay) {
...
fun View.fadeInHorizontal(startDelay: Long = 0, build: (ViewPropertyAnimator.() -> Unit)? = null)
        = translate(initX = AnimationConstants.TRANSLATION_SMALL, translationX = 0, alpha = 1f, startDelay = startDelay) {
    duration = AnimationConstants.MEDIUM
    interpolator = AnimationConstants.LINEAR_OUT_SLOW_IN
    build?.invoke(this)
}
...
fun View.fadeOutHorizontal(startDelay: Long = 0, build: (ViewPropertyAnimator.() -> Unit)? = null)
        = translate(translationX = -AnimationConstants.TRANSLATION_SMALL, alpha = 0f, startDelay = startDelay) {
    duration = AnimationConstants.SHORT
    interpolator = AnimationConstants.FAST_OUT_SLOW_IN
    setListener(null)
    build?.invoke(this)
...
fun View.easeInVertical(startDelay: Long = 0, build: (ViewPropertyAnimator.() -> Unit)? = null)
        = easeViewsInVertical(startDelay, this) { build?.let { build() } }
...
fun View.easeInHorizontal(startDelay: Long = 0, build: (ViewPropertyAnimator.() -> Unit)? = null)
        = easeViewsInHorizontal(startDelay, this) { build?.let { build() } }
...
fun View.easeOutVertical(startDelay: Long = 0, build: (ViewPropertyAnimator.() -> Unit)? = null)
        = easeViewsOutVertical(startDelay, this) { build?.let { build() } }
...
fun View.easeOutHorizontal(startDelay: Long = 0, build: (ViewPropertyAnimator.() -> Unit)? = null)
        = easeViewsOutHorizontal(startDelay, this) { build?.let { build() } }
...
fun View.reveal(show: Boolean = true, centerX: Int? = null, centerY: Int? = null,
    ...
    val anim = ViewAnimationUtils.createCircularReveal(this,
            ...
            startRadius?.toFloat() ?: if (show) 0f else radius, endRadius?.toFloat() ?: if (show) radius else 0f
    )
...
fun View.hide(centerX: Int? = null, centerY: Int? = null, build: (Animator.() -> Unit)? = null)
        = reveal(false, centerX, centerY, null, null, build)
